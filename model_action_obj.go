...
// checks if the ActionObj type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionObj{}
...
func (o ActionObj) ToMap() (map[string]interface{}, error) {
